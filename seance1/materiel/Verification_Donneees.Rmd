...
Les gènes pour lesquels nous savons qu'elle doit être l'expression dans les échantillons sont:  
- *ARP6* (AT3G33520)  
...
> - Transformer le format de manière à avoir une colonne avec le nom de l'échantillon et une colonne avec les valeurs d'expression en utilisant `pivot_longer`  
