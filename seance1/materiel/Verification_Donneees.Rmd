...
Une des premières vérifications biologique que nous faisons sur nos données est de s'assurer que les 3 réplicats pour chaque génotype et condition sont suffisamment similaire. Pour cela nous utilisons une méthode de visualisation: **l'Analyse en Composante Principale (ACP)**. Avant d'aller plus loin, si vous ne connaissez pas le principe de l'ACP, je vous recommande de regarder cette [vidéo d'introduction à l'ACP](https://www.youtube.com/watch?v=y5hzRYZxd4Y&ab_channel=EpiMedOpenCourse).  
