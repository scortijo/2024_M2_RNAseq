...
- Pour cela nous ne gardons que les colonnes d'intérêt (nom des gènes et p-value ajustée), et renommons la colonne la p-value ajustée (padj) afin d'y ajouter l'information de la comparaison d'où elle vient:
```{r}
