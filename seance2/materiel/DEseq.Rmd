...
keep_10mM <- rowSums(counts(ddsHTSeq_10mM)) >= 4
ddsHTSeq_10mM <- ddsHTSeq_10mM[keep_10mM,]

keep2_10mM <- rowSums(counts(ddsHTSeq_10mM)<0.0001) < 3
ddsHTSeq_10mM <- ddsHTSeq_10mM[keep2_10mM,]
...
keep_WT <- rowSums(counts(ddsHTSeq_WT)) >= 4
ddsHTSeq_WT <- ddsHTSeq_WT[keep_WT,]

keep2_WT <- rowSums(counts(ddsHTSeq_WT)<0.0001) < 3
ddsHTSeq_WT <- ddsHTSeq_WT[keep2_WT,]
...
keep_arp6 <- rowSums(counts(ddsHTSeq_arp6)) >= 4
ddsHTSeq_arp6 <- ddsHTSeq_arp6[keep_arp6,]

keep2_arp6 <- rowSums(counts(ddsHTSeq_arp6)<0.0001) < 3
ddsHTSeq_arp6 <- ddsHTSeq_arp6[keep2_arp6,]
